...
static PERL_SIGNAL_ARGS_REC perl_signal_args[] =
{
    ...
    { "proxy client command", { "Irssi::Irc::Client", "string", "string", NULL } },
    { "proxy client dump", { "Irssi::Irc::Client", "string", NULL } },
    ...
    { "window dehilight", { "Irssi::UI::Window", NULL } },
    ...
    { "window item moved", { "Irssi::UI::Window", "iobject", "Irssi::UI::Window", NULL } },
    ...
    { "default event numeric", { "iobject", "string", "string", "string", NULL } },
